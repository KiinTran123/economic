                ...
                <div class="col-sm-6">
                    <div class="slider-zoom">
                        <a href="assets/img/meats.jpg" class="cloud-zoom" rel="transparentImage: 'data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==', useWrapper: false, showTitle: false, zoomWidth:'500', zoomHeight:'500', adjustY:0, adjustX:10" id="cloudZoom">
                            <img alt="Chi tiết hình ảnh phóng to" src="assets/img/meats.jpg" style="width: 100%;">
                        </a>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <p>
                                <span class="stock available">Còn hàng: 99</span>
                            </p>
                        </div>
                    </div>
                    <p class="mb-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6"><span class="pt-1 d-inline-block">Gói (250 gram)</span></div>
                    </div>
