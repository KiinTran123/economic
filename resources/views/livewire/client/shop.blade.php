<div id="page-content" class="page-content">
    ...
    @endif
    <section id="most-wanted" wire:ignore>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <section id="vegetables" class="gray-bg" wire:ignore>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <section id="fishes" class="gray-bg" wire:ignore>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
