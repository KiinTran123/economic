                    ...
                    <form wire:submit.prevent="save" class="bill-detail" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <select wire:model="selectedProvince" wire:change="updateSelectedProvince" class="form-control" id="city">
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="address_detail" class="form-control" id="address_detail" type="text" placeholder="Số nhà, tên đường, v.v.">
