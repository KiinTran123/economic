            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="{{ $post->thumbnail ? asset('storage/'.$post->thumbnail) : 'https://tse1.mm.bing.net/th/id/OIP.52YQJGp8zBSA6UX2kBAPPAHaDC?w=1500&h=617&rs=1&pid=ImgDetMain' }}" class="img-fluid mb-4 thumbnail-img" alt="Thumbnail">
